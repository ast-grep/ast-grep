...
#### [0.45.3](https://github.com/ast-grep/ast-grep/compare/0.45.2...0.45.3)

- chore(deps): update dependency dprint to v0.57.0 [`#2916`](https://github.com/ast-grep/ast-grep/pull/2916)
- feat: add min-severity cli [`#2917`](https://github.com/ast-grep/ast-grep/pull/2917)
- fix(outline): anchor fallback signatures to names [`#2913`](https://github.com/ast-grep/ast-grep/pull/2913)
- feat(outline): add Markdown heading support [`#2912`](https://github.com/ast-grep/ast-grep/pull/2912)
- chore(deps): update dependency oxlint to v1.80.0 [`#2908`](https://github.com/ast-grep/ast-grep/pull/2908)
- chore(deps): update dependency @ast-grep/napi to v0.45.2 [`#2906`](https://github.com/ast-grep/ast-grep/pull/2906)
- feat: add min-severity cli (#2917) [`#2720`](https://github.com/ast-grep/ast-grep/issues/2720)
- fix: ast-grep-ignore must be at first be the frist alphabet to take effect [`#2909`](https://github.com/ast-grep/ast-grep/issues/2909)
- chore: update tree-sitter 0.27 [`bb74529`](https://github.com/ast-grep/ast-grep/commit/bb745292b5e683822c27612858b5b0edb54e273e)
- fix: fix clippy [`c6b32d7`](https://github.com/ast-grep/ast-grep/commit/c6b32d74ad12cea690cb331c88f004764df6e985)

#### [0.45.2](https://github.com/ast-grep/ast-grep/compare/0.45.1...0.45.2)

> 23 August 2026

- chore(deps): update astral-sh/setup-uv action to v10 [`#2892`](https://github.com/ast-grep/ast-grep/pull/2892)
- chore(deps): update rust crate terminal-light to v1.9.1 [`#2905`](https://github.com/ast-grep/ast-grep/pull/2905)
- chore(deps): update dependency web-tree-sitter to v0.26.13 [`#2903`](https://github.com/ast-grep/ast-grep/pull/2903)
- chore(deps): update rust crate tree-sitter to v0.26.13 [`#2904`](https://github.com/ast-grep/ast-grep/pull/2904)
- chore(deps): update dependency dprint to v0.56.1 [`#2901`](https://github.com/ast-grep/ast-grep/pull/2901)
- chore(deps): update dependency @napi-rs/cli to v3.8.6 [`#2882`](https://github.com/ast-grep/ast-grep/pull/2882)
- fix(deps): update rust-wasm-bindgen monorepo [`#2878`](https://github.com/ast-grep/ast-grep/pull/2878)
- chore(deps): update dependency dprint to v0.56.0 [`#2896`](https://github.com/ast-grep/ast-grep/pull/2896)
- chore(deps): update dependency oxlint to v1.79.0 [`#2897`](https://github.com/ast-grep/ast-grep/pull/2897)
- chore(deps): update dependency @ast-grep/napi to v0.45.1 [`#2876`](https://github.com/ast-grep/ast-grep/pull/2876)
- chore(deps): update dependency web-tree-sitter to v0.26.12 [`#2880`](https://github.com/ast-grep/ast-grep/pull/2880)
- fix: exit quietly on broken pipe instead of erroring [`#2887`](https://github.com/ast-grep/ast-grep/pull/2887)
- feat(outline): extract embedded language symbols [`#2883`](https://github.com/ast-grep/ast-grep/pull/2883)
- chore(deps): update dependency oxlint to v1.78.0 [`#2888`](https://github.com/ast-grep/ast-grep/pull/2888)
- feat: add namedChildren support to wasm [`#2893`](https://github.com/ast-grep/ast-grep/issues/2893)
- feat: add namedChildren to napi [`#2893`](https://github.com/ast-grep/ast-grep/issues/2893)
- feat: add named_children to pyo3 [`4dc0d36`](https://github.com/ast-grep/ast-grep/commit/4dc0d3605ac027e45f5feb811966fe7b8220d246)
- fix: bump down napi [`61f1b98`](https://github.com/ast-grep/ast-grep/commit/61f1b98cc2379b9a6d37173257612b5aac3473da)
- chore: bump deps [`912da32`](https://github.com/ast-grep/ast-grep/commit/912da3272afd258ec464ee8c2e52d19059a620e4)

#### [0.45.1](https://github.com/ast-grep/ast-grep/compare/0.45.0...0.45.1)

> 7 August 2026

- fix: match root metavariables against comments [`#2868`](https://github.com/ast-grep/ast-grep/pull/2868)
- feat(outline): add C# multiline member signatures [`#2861`](https://github.com/ast-grep/ast-grep/pull/2861)
- chore(deps): update rust crate ignore to v0.4.32 [`#2864`](https://github.com/ast-grep/ast-grep/pull/2864)
- chore(deps): update dependency oxlint to v1.77.0 [`#2865`](https://github.com/ast-grep/ast-grep/pull/2865)
- chore(deps): update dependency typescript to v7 [`#2833`](https://github.com/ast-grep/ast-grep/pull/2833)
- chore(deps): update astral-sh/setup-uv action to v9 [`#2839`](https://github.com/ast-grep/ast-grep/pull/2839)
- chore(deps): update dependency smol-toml to v1.7.1 [`#2848`](https://github.com/ast-grep/ast-grep/pull/2848)
- chore(deps): update dependency @napi-rs/cli to v3.8.2 [`#2854`](https://github.com/ast-grep/ast-grep/pull/2854)
- chore(deps): update dependency chalk to v6 [`#2849`](https://github.com/ast-grep/ast-grep/pull/2849)
- chore(deps): update rust crate clap to v4.6.5 [`#2860`](https://github.com/ast-grep/ast-grep/pull/2860)
- chore(deps): update rust crate clap_complete to v4.6.8 [`#2850`](https://github.com/ast-grep/ast-grep/pull/2850)
- chore(deps): update rust crate schemars to v1.2.2 [`#2851`](https://github.com/ast-grep/ast-grep/pull/2851)
- chore(deps): update dependency oxlint to v1.76.0 [`#2852`](https://github.com/ast-grep/ast-grep/pull/2852)
- chore(deps): update rust crate napi to v3.12.0 [`#2855`](https://github.com/ast-grep/ast-grep/pull/2855)
- chore(deps): update rust crate napi-derive to v3.6.2 [`#2853`](https://github.com/ast-grep/ast-grep/pull/2853)
- Use `std::io::IsTerminal` over `atty` [`#2857`](https://github.com/ast-grep/ast-grep/pull/2857)
- chore(deps): update dependency @ast-grep/napi to v0.45.0 [`#2844`](https://github.com/ast-grep/ast-grep/pull/2844)
- chore: bump deps [`2ac18ca`](https://github.com/ast-grep/ast-grep/commit/2ac18ca571a5d6a50dd549d7bf9b0cb704f0dd87)

#### [0.45.0](https://github.com/ast-grep/ast-grep/compare/0.44.1...0.45.0)

> 23 July 2026

- feat: deprecate the sg command [`#2843`](https://github.com/ast-grep/ast-grep/pull/2843)
- fix: avoid Defender false positive for Windows sg [`#2842`](https://github.com/ast-grep/ast-grep/pull/2842)
- chore(deps): update dependency @napi-rs/cli to v3.7.4 [`#2834`](https://github.com/ast-grep/ast-grep/pull/2834)
- chore(deps): update dependency oxlint to v1.75.0 [`#2838`](https://github.com/ast-grep/ast-grep/pull/2838)
- chore(deps): update actions/setup-node action to v7 [`#2810`](https://github.com/ast-grep/ast-grep/pull/2810)
- chore(deps): update actions/setup-python action to v7 [`#2829`](https://github.com/ast-grep/ast-grep/pull/2829)
- fix: specify correct MSRV in Cargo.toml [`#2837`](https://github.com/ast-grep/ast-grep/pull/2837)
- Revert "chore(deps): update dependency typescript to v7 (#2795)" [`#2831`](https://github.com/ast-grep/ast-grep/pull/2831)
- chore(deps): update astral-sh/setup-uv action to v8.3.2 [`#2790`](https://github.com/ast-grep/ast-grep/pull/2790)
- chore(deps): update dependency typescript to v7 [`#2795`](https://github.com/ast-grep/ast-grep/pull/2795)
- chore(deps): update rust crate thiserror to v2.0.19 [`#2819`](https://github.com/ast-grep/ast-grep/pull/2819)
- chore(deps): update dependency @napi-rs/cli to v3.7.3 [`#2801`](https://github.com/ast-grep/ast-grep/pull/2801)
- chore(deps): update dependency web-tree-sitter to v0.26.11 [`#2802`](https://github.com/ast-grep/ast-grep/pull/2802)
- chore(deps): update rust crate target-triple to v1.0.1 [`#2817`](https://github.com/ast-grep/ast-grep/pull/2817)
- chore(deps): update dependency oxlint to v1.74.0 [`#2809`](https://github.com/ast-grep/ast-grep/pull/2809)
- chore(deps): update dependency dprint to v0.55.2 [`#2808`](https://github.com/ast-grep/ast-grep/pull/2808)
- chore(deps): update dependency @ast-grep/napi to v0.44.1 [`#2789`](https://github.com/ast-grep/ast-grep/pull/2789)
- chore(deps): update dependency oxlint to v1.73.0 [`#2793`](https://github.com/ast-grep/ast-grep/pull/2793)
- chore(deps): update dependency @types/node to v24.13.3 [`#2794`](https://github.com/ast-grep/ast-grep/pull/2794)
- chore(deps): update rust crate bit-set to 0.11.0 [`#2791`](https://github.com/ast-grep/ast-grep/pull/2791)
- fix: use is_extra instead of comment heuristic [`#2821`](https://github.com/ast-grep/ast-grep/issues/2821)
- fix: stop using ignore files outside rule_dirs [`#2803`](https://github.com/ast-grep/ast-grep/issues/2803)
- chore: update dependencies [`b24ca85`](https://github.com/ast-grep/ast-grep/commit/b24ca85a7aa5aa3e0925da575e8800209f918421)
- feat(outline): support ambient TypeScript modules [`4f75c21`](https://github.com/ast-grep/ast-grep/commit/4f75c214094e46d0d3f026674027036459840d61)
- chore: bump versions [`82eb291`](https://github.com/ast-grep/ast-grep/commit/82eb2916782ae5ed572813272f5845214b5aa321)

#### [0.44.1](https://github.com/ast-grep/ast-grep/compare/0.44.0...0.44.1)

> 4 July 2026

- chore(deps): update rust crate napi to v3.10.3 [`#2786`](https://github.com/ast-grep/ast-grep/pull/2786)
- chore(deps): update rust crate napi-derive to v3.5.9 [`#2785`](https://github.com/ast-grep/ast-grep/pull/2785)
- chore(deps): update dependency oxlint to v1.72.0 [`#2780`](https://github.com/ast-grep/ast-grep/pull/2780)
- chore(deps): update rust crate terminal-light to v1.9.0 [`#2781`](https://github.com/ast-grep/ast-grep/pull/2781)
- chore(deps): update rust crate clap_complete to v4.6.7 [`#2783`](https://github.com/ast-grep/ast-grep/pull/2783)
- chore(deps): update rust crate ignore to v0.4.27 [`#2784`](https://github.com/ast-grep/ast-grep/pull/2784)
- fix(cli): bound outline file queue [`#2787`](https://github.com/ast-grep/ast-grep/pull/2787)
- chore(deps): update rust crate clap_complete to v4.6.6 [`#2782`](https://github.com/ast-grep/ast-grep/pull/2782)
...
- chore(deps): update dependency web-tree-sitter to v0.26.10 [`#2778`](https://github.com/ast-grep/ast-grep/pull/2778)
- chore(deps): update dependency dprint to v0.55.1 [`#2776`](https://github.com/ast-grep/ast-grep/pull/2776)
- chore(deps): update dependency @napi-rs/cli to v3.7.2 [`#2667`](https://github.com/ast-grep/ast-grep/pull/2667)
- chore(deps): update rust crate napi to v3.9.4 [`#2696`](https://github.com/ast-grep/ast-grep/pull/2696)
- chore(deps): update rust crate napi-derive to v3.5.7 [`#2768`](https://github.com/ast-grep/ast-grep/pull/2768)
- chore(deps): update rust crate anyhow to v1.0.103 [`#2774`](https://github.com/ast-grep/ast-grep/pull/2774)
- feat: load custom language outline rules from config [`#2777`](https://github.com/ast-grep/ast-grep/pull/2777)
- fix(deps): update rust-wasm-bindgen monorepo [`#2775`](https://github.com/ast-grep/ast-grep/pull/2775)
- chore(deps): update actions/cache action to v6 [`#2767`](https://github.com/ast-grep/ast-grep/pull/2767)
- feat: Support *.bazel files in python [`#2771`](https://github.com/ast-grep/ast-grep/pull/2771)
- chore(deps): update oxlint monorepo [`#2765`](https://github.com/ast-grep/ast-grep/pull/2765)
- feat: add outline rules for more builtin languages [`07778fb`](https://github.com/ast-grep/ast-grep/commit/07778fb326765363557811d5b24e901399bfbdec)
- fix: update pyo3 deps [`1713e86`](https://github.com/ast-grep/ast-grep/commit/1713e86fd5960accbe59532eafaf307c6330b303)

#### [0.44.0](https://github.com/ast-grep/ast-grep/compare/0.43.0...0.44.0)

> 21 June 2026

- chore: move outline docs and benchmarks out of repo [`#2763`](https://github.com/ast-grep/ast-grep/pull/2763)
- chore(deps): update dependency smol-toml to v1.7.0 [`#2762`](https://github.com/ast-grep/ast-grep/pull/2762)
- Add JavaScript outline rules and stream JSON files [`#2761`](https://github.com/ast-grep/ast-grep/pull/2761)
- fix: reject root multi-metavariable patterns [`#2727`](https://github.com/ast-grep/ast-grep/pull/2727)
- fix: don't leak metavar bindings across siblings in nthChild ofRule [`#2677`](https://github.com/ast-grep/ast-grep/pull/2677)
- fix: extract python from-import modules in outline [`#2758`](https://github.com/ast-grep/ast-grep/pull/2758)
- fix: match go outline types by declaration [`#2759`](https://github.com/ast-grep/ast-grep/pull/2759)
- fix: skip empty files in outline [`#2757`](https://github.com/ast-grep/ast-grep/pull/2757)
- feat: mark duplicate outline names [`#2756`](https://github.com/ast-grep/ast-grep/pull/2756)
- refactor: inline outline member kind lookup [`#2755`](https://github.com/ast-grep/ast-grep/pull/2755)
- refactor: make outline extract return iterator [`#2754`](https://github.com/ast-grep/ast-grep/pull/2754)
- refactor: stream outline extraction items [`#2753`](https://github.com/ast-grep/ast-grep/pull/2753)
- perf: use single traversal for outline extraction [`#2751`](https://github.com/ast-grep/ast-grep/pull/2751)
- perf: cache transform replace regexes [`#2750`](https://github.com/ast-grep/ast-grep/pull/2750)
- fix: don't leak metavar bindings from a negated `not` rule [`#2676`](https://github.com/ast-grep/ast-grep/pull/2676)
- refactor: fold outline extract options into extractors [`#2749`](https://github.com/ast-grep/ast-grep/pull/2749)
- refactor: split outline extract options and style [`#2748`](https://github.com/ast-grep/ast-grep/pull/2748)
- refactor: map outline cli to core options [`#2747`](https://github.com/ast-grep/ast-grep/pull/2747)
- feat: apply outline extractor options [`#2746`](https://github.com/ast-grep/ast-grep/pull/2746)
- feat: add outline extractor options [`#2745`](https://github.com/ast-grep/ast-grep/pull/2745)
- fix: simplify some code [`#2744`](https://github.com/ast-grep/ast-grep/pull/2744)
- fix: trailing ast-grep-ignore on a multi-line statement suppresses it [`#2678`](https://github.com/ast-grep/ast-grep/pull/2678)
- chore(deps): update actions/checkout action to v7 [`#2731`](https://github.com/ast-grep/ast-grep/pull/2731)
- fix: cover async rust outline rules [`#2743`](https://github.com/ast-grep/ast-grep/pull/2743)
- feat: add bundled outline rules for more languages [`#2739`](https://github.com/ast-grep/ast-grep/pull/2739)
- feat: add outline CLI command [`#2738`](https://github.com/ast-grep/ast-grep/pull/2738)
- perf: use cursor-backed outline traversal [`#2737`](https://github.com/ast-grep/ast-grep/pull/2737)
- feat: run outline extractors [`#2729`](https://github.com/ast-grep/ast-grep/pull/2729)
- chore(deps): update oxlint monorepo to v1.70.0 [`#2726`](https://github.com/ast-grep/ast-grep/pull/2726)
- refactor: split fixer variable validation [`#2724`](https://github.com/ast-grep/ast-grep/pull/2724)
- refactor: validate rule core directly [`#2723`](https://github.com/ast-grep/ast-grep/pull/2723)
- test: move matcher tests to rule core [`#2722`](https://github.com/ast-grep/ast-grep/pull/2722)
- refactor: wrap rewriter config errors [`#2721`](https://github.com/ast-grep/ast-grep/pull/2721)
- test: validate global rule fix vars via rule config [`#2719`](https://github.com/ast-grep/ast-grep/pull/2719)
- fix: check undefined meta var in fix [`#2718`](https://github.com/ast-grep/ast-grep/pull/2718)
- **Breaking change:** fix: remove fix from SerializableCore [`#2717`](https://github.com/ast-grep/ast-grep/pull/2717)
- fix: preserve unused suppression fixer [`#2716`](https://github.com/ast-grep/ast-grep/pull/2716)
- **Breaking change:** refactor: move optional fixer to RuleConfig [`#2715`](https://github.com/ast-grep/ast-grep/pull/2715)
- fix: add fixer var check [`#2714`](https://github.com/ast-grep/ast-grep/pull/2714)
- Refactor rule config [`#2713`](https://github.com/ast-grep/ast-grep/pull/2713)
- **Breaking change:** refactor: mvoe rewriters into SerializableRuleCore [`#2711`](https://github.com/ast-grep/ast-grep/pull/2711)
- refactor: move rewriter out [`#2712`](https://github.com/ast-grep/ast-grep/pull/2712)
- feat: add outline rule schema [`#2710`](https://github.com/ast-grep/ast-grep/pull/2710)
- docs: remove outline target alias fields [`#2709`](https://github.com/ast-grep/ast-grep/pull/2709)
- chore(deps): update rust crate smallvec to v1.15.2 [`#2701`](https://github.com/ast-grep/ast-grep/pull/2701)
- fix(deps): update rust-wasm-bindgen monorepo [`#2704`](https://github.com/ast-grep/ast-grep/pull/2704)
- fix: remove unused trait/methods [`#2708`](https://github.com/ast-grep/ast-grep/pull/2708)
- feat: add outline entry model [`#2703`](https://github.com/ast-grep/ast-grep/pull/2703)
- refactor: remove legacy outline placeholders [`#2702`](https://github.com/ast-grep/ast-grep/pull/2702)
- feat: add outline CLI shell [`#2700`](https://github.com/ast-grep/ast-grep/pull/2700)
- fix(deps): update rust-wasm-bindgen monorepo [`#2693`](https://github.com/ast-grep/ast-grep/pull/2693)
- chore(deps): update oxlint monorepo to v1.69.0 [`#2692`](https://github.com/ast-grep/ast-grep/pull/2692)
- chore(deps): update rust crate regex to v1.12.4 [`#2694`](https://github.com/ast-grep/ast-grep/pull/2694)
- chore(deps): update dependency @types/node to v24.13.2 [`#2698`](https://github.com/ast-grep/ast-grep/pull/2698)
- doc: design outline command [`#2699`](https://github.com/ast-grep/ast-grep/pull/2699)
- Outline first builtin rule [`#2695`](https://github.com/ast-grep/ast-grep/pull/2695)
- chore(deps): update rust crate tree-sitter-swift to v0.7.3 [`#2672`](https://github.com/ast-grep/ast-grep/pull/2672)
- chore(deps): update astral-sh/setup-uv action to v8.2.0 [`#2680`](https://github.com/ast-grep/ast-grep/pull/2680)
- feat: add outline rule definition [`#2691`](https://github.com/ast-grep/ast-grep/pull/2691)
- feat: add outline item model [`#2690`](https://github.com/ast-grep/ast-grep/pull/2690)
- chore(deps): update codecov/codecov-action action to v7 [`#2686`](https://github.com/ast-grep/ast-grep/pull/2686)
- feat: add outline command stub [`#2689`](https://github.com/ast-grep/ast-grep/pull/2689)
- chore(deps): update dependency @types/node to v24.13.1 [`#2682`](https://github.com/ast-grep/ast-grep/pull/2682)
- chore(deps): update rust crate ignore to v0.4.26 [`#2683`](https://github.com/ast-grep/ast-grep/pull/2683)
- fix: remove all impl, start from scratch [`#2688`](https://github.com/ast-grep/ast-grep/pull/2688)
- fix: remove all impl, start from scratch [`#2687`](https://github.com/ast-grep/ast-grep/pull/2687)
- fix: report unfixable scan hits with update-all [`#2684`](https://github.com/ast-grep/ast-grep/pull/2684)
- Fix typos in comments and grammar in --help text [`#2674`](https://github.com/ast-grep/ast-grep/pull/2674)
- chore(deps): update dependency oxlint to v1.68.0 [`#2673`](https://github.com/ast-grep/ast-grep/pull/2673)
- fix: don't leak metavar bindings from ellipsis-end lookahead [`#2670`](https://github.com/ast-grep/ast-grep/pull/2670)
- refactor: collapse nested ifs with let chains [`#2671`](https://github.com/ast-grep/ast-grep/pull/2671)
- chore(deps): update rust crate toml_edit to v0.25.12 [`#2666`](https://github.com/ast-grep/ast-grep/pull/2666)
- chore(deps): update dependency oxlint to v1.67.0 [`#2665`](https://github.com/ast-grep/ast-grep/pull/2665)
- chore(deps): update dependency @ast-grep/napi to v0.43.0 [`#2664`](https://github.com/ast-grep/ast-grep/pull/2664)
- add benchmark [`b488bd3`](https://github.com/ast-grep/ast-grep/commit/b488bd3ea1fbd62e354831ab3b6bf71439e6e004)
- vibe [`6f89a3d`](https://github.com/ast-grep/ast-grep/commit/6f89a3d8b9260666908b68007dff487b599d1a95)
- fix: update outline rule loading [`202d8b8`](https://github.com/ast-grep/ast-grep/commit/202d8b89ddadaa6e1d30eefcc0136b83d98b5222)

#### [0.43.0](https://github.com/ast-grep/ast-grep/compare/0.42.3...0.43.0)

> 25 May 2026

- chore(deps): update dependency @types/node to v24.12.4 [`#2636`](https://github.com/ast-grep/ast-grep/pull/2636)
- chore(deps): update rust crate assert_cmd to v2.2.2 [`#2632`](https://github.com/ast-grep/ast-grep/pull/2632)
- chore(deps): update rust crate similar to v3.1.1 [`#2662`](https://github.com/ast-grep/ast-grep/pull/2662)
- fix(lsp): initialize tracing subscriber to surface tower-lsp errors [`#2639`](https://github.com/ast-grep/ast-grep/pull/2639)
- fix(deps): update rust-wasm-bindgen monorepo [`#2660`](https://github.com/ast-grep/ast-grep/pull/2660)
- chore(deps): update rust crate tree-sitter to v0.26.9 [`#2656`](https://github.com/ast-grep/ast-grep/pull/2656)
- chore(deps): update rust crate serde_json to v1.0.150 [`#2659`](https://github.com/ast-grep/ast-grep/pull/2659)
- chore(deps): update rust crate clap_complete to v4.6.5 [`#2634`](https://github.com/ast-grep/ast-grep/pull/2634)
- chore(deps): update dependency @ast-grep/napi to v0.42.3 [`#2653`](https://github.com/ast-grep/ast-grep/pull/2653)
- chore(deps): update dependency oxlint to v1.66.0 [`#2651`](https://github.com/ast-grep/ast-grep/pull/2651)
- chore(deps): update dependency web-tree-sitter to v0.26.9 [`#2654`](https://github.com/ast-grep/ast-grep/pull/2654)
- fix: strip trailing comment artifact in comment suppression [`#2644`](https://github.com/ast-grep/ast-grep/issues/2644)
- feat: support ESQuery style selector in run command [`#2663`](https://github.com/ast-grep/ast-grep/issues/2663)
- feat: add --follow arg for sg test [`#2657`](https://github.com/ast-grep/ast-grep/issues/2657)
- test: add test for run --kind [`d0d0b30`](https://github.com/ast-grep/ast-grep/commit/d0d0b3003e19593c16dd91c9e26d77567971e477)
- feat: add markdown support [`beacc9e`](https://github.com/ast-grep/ast-grep/commit/beacc9e40c81e33bb3f94298e4a5b6cb046c0d56)
- fix: use Rule instead of pattern in run [`2759fda`](https://github.com/ast-grep/ast-grep/commit/2759fdaeb9e15264276b8671a565d591d93e8e36)

#### [0.42.3](https://github.com/ast-grep/ast-grep/compare/0.42.2...0.42.3)

> 19 May 2026

- feat: support nth-last-child esquery [`#2631`](https://github.com/ast-grep/ast-grep/pull/2631)
- chore(deps): update rust crate dashmap to v6.2.1 [`#2645`](https://github.com/ast-grep/ast-grep/pull/2645)
- chore(deps): update dependency oxlint to v1.65.0 [`#2635`](https://github.com/ast-grep/ast-grep/pull/2635)
- chore(deps): update rust crate napi-derive to v3.5.6 [`#2642`](https://github.com/ast-grep/ast-grep/pull/2642)
- chore(deps): update rust crate napi-build to v2.3.2 [`#2641`](https://github.com/ast-grep/ast-grep/pull/2641)
- chore(deps): update rust crate napi to v3.9.0 [`#2643`](https://github.com/ast-grep/ast-grep/pull/2643)
- chore(deps): update dependency @ast-grep/napi to v0.42.2 [`#2630`](https://github.com/ast-grep/ast-grep/pull/2630)
- fix: fix windows installation [`4021ae0`](https://github.com/ast-grep/ast-grep/commit/4021ae076f15ae6833d6e69f6429555071b4eac8)

#### [0.42.2](https://github.com/ast-grep/ast-grep/compare/0.42.1...0.42.2)

> 10 May 2026

- chore(deps): update rust crate tokio to v1.52.3 [`#2620`](https://github.com/ast-grep/ast-grep/pull/2620)
- fix(deps): update rust-wasm-bindgen monorepo [`#2623`](https://github.com/ast-grep/ast-grep/pull/2623)
- chore(deps): update rust crate clap_complete to v4.6.4 [`#2627`](https://github.com/ast-grep/ast-grep/pull/2627)
- chore(deps): update dependency @types/node to v24.12.3 [`#2624`](https://github.com/ast-grep/ast-grep/pull/2624)
- chore(deps): update rust crate tree-sitter-swift to v0.7.2 [`#2619`](https://github.com/ast-grep/ast-grep/pull/2619)
- chore(deps): update dependency oxlint to v1.63.0 [`#2621`](https://github.com/ast-grep/ast-grep/pull/2621)
- fix: replace postinstall script with binary resolution in ast-grep [`#2595`](https://github.com/ast-grep/ast-grep/pull/2595)
- fix(lsp): use cwd instead of config dir as workspace fallback [`#2600`](https://github.com/ast-grep/ast-grep/pull/2600)
- fix(deps): update rust-wasm-bindgen monorepo [`#2613`](https://github.com/ast-grep/ast-grep/pull/2613)
- chore(deps): update rust crate napi-derive to v3.5.5 [`#2615`](https://github.com/ast-grep/ast-grep/pull/2615)
- chore(deps): update rust crate napi to v3.8.6 [`#2614`](https://github.com/ast-grep/ast-grep/pull/2614)
- chore(deps): update rust crate clap_complete to v4.6.3 [`#2610`](https://github.com/ast-grep/ast-grep/pull/2610)
- chore(deps): update dependency oxlint to v1.62.0 [`#2611`](https://github.com/ast-grep/ast-grep/pull/2611)
- chore(deps): update astral-sh/setup-uv action to v8 [`#2604`](https://github.com/ast-grep/ast-grep/pull/2604)
- chore(deps): update rust crate tree-sitter-c to v0.24.2 [`#2608`](https://github.com/ast-grep/ast-grep/pull/2608)
- fix(deps): update rust crate tree-sitter-dart to 0.2.0 [`#2609`](https://github.com/ast-grep/ast-grep/pull/2609)
- chore(deps): update robinraju/release-downloader action to v1.13 [`#2606`](https://github.com/ast-grep/ast-grep/pull/2606)
- fix(lsp): report unused suppressions without rules [`#2607`](https://github.com/ast-grep/ast-grep/pull/2607)
- chore(deps): update rust crate clap_complete to v4.6.2 [`#2589`](https://github.com/ast-grep/ast-grep/pull/2589)
- chore(deps): update dependency oxlint to v1.61.0 [`#2605`](https://github.com/ast-grep/ast-grep/pull/2605)
- chore(deps): update rust crate similar to v3.1.0 [`#2587`](https://github.com/ast-grep/ast-grep/pull/2587)
- fix(deps): update rust crate tree-sitter-scala to 0.26.0 [`#2602`](https://github.com/ast-grep/ast-grep/pull/2602)
- chore(deps): update rust crate tree-sitter-scala to v0.25.1 [`#2601`](https://github.com/ast-grep/ast-grep/pull/2601)
- chore(deps): update rust crate tree-sitter-c-sharp to v0.23.5 [`#2591`](https://github.com/ast-grep/ast-grep/pull/2591)
- chore(deps): update dependency oxlint to v1.60.0 [`#2588`](https://github.com/ast-grep/ast-grep/pull/2588)
- chore(deps): update rust crate assert_cmd to v2.2.1 [`#2599`](https://github.com/ast-grep/ast-grep/pull/2599)
- chore(deps): update dependency typescript to v6.0.3 [`#2598`](https://github.com/ast-grep/ast-grep/pull/2598)
- chore(deps): update dependency @napi-rs/cli to v3.6.2 [`#2593`](https://github.com/ast-grep/ast-grep/pull/2593)
- chore(deps): update rust crate napi-derive to v3.5.4 [`#2597`](https://github.com/ast-grep/ast-grep/pull/2597)
- chore(deps): update rust crate napi to v3.8.5 [`#2596`](https://github.com/ast-grep/ast-grep/pull/2596)
- chore(deps): update rust crate tokio to v1.52.1 [`#2592`](https://github.com/ast-grep/ast-grep/pull/2592)
- chore(deps): update rust crate clap to v4.6.1 [`#2594`](https://github.com/ast-grep/ast-grep/pull/2594)
- chore(deps): update pyo3/maturin-action action to v1.51.0 [`#2510`](https://github.com/ast-grep/ast-grep/pull/2510)
- fix(deps): update rust-wasm-bindgen monorepo [`#2568`](https://github.com/ast-grep/ast-grep/pull/2568)
- chore(deps): update dependency @napi-rs/cli to v3.6.1 [`#2583`](https://github.com/ast-grep/ast-grep/pull/2583)
- chore(deps): update dependency @ast-grep/napi to v0.42.1 [`#2580`](https://github.com/ast-grep/ast-grep/pull/2580)
- chore(deps): update dependency oxlint to v1.59.0 [`#2581`](https://github.com/ast-grep/ast-grep/pull/2581)
- chore(deps): update rust crate toml_edit to v0.25.11 [`#2582`](https://github.com/ast-grep/ast-grep/pull/2582)
- chore(deps): update rust crate tokio to v1.51.1 [`#2584`](https://github.com/ast-grep/ast-grep/pull/2584)
- chore(deps): update dependency dprint to v0.54.0 [`#2585`](https://github.com/ast-grep/ast-grep/pull/2585)
- chore(deps): update rust crate clap_complete to v4.6.1 [`#2586`](https://github.com/ast-grep/ast-grep/pull/2586)
- chore(deps): update dependency @types/node to v24.12.2 [`#2579`](https://github.com/ast-grep/ast-grep/pull/2579)
- fix: enable npx install fallback but still keep postinstall [`fbc5b9b`](https://github.com/ast-grep/ast-grep/commit/fbc5b9b67d7f7f4e86406a7fcf491cbfab327098)
- chore: bump kotlin version [`6f09a5b`](https://github.com/ast-grep/ast-grep/commit/6f09a5b02dc95ab083b614b4d972059b9afe3a23)
- fix: solve linting [`945328a`](https://github.com/ast-grep/ast-grep/commit/945328aa3157370ce8fcc207358e29490d257fb6)
...
- chore(deps): update dependency @types/node to v24.12.0 [`#2518`](https://github.com/ast-grep/ast-grep/pull/2518)
- fix(deps): update rust crate tree-sitter-lua to 0.5.0 [`#2506`](https://github.com/ast-grep/ast-grep/pull/2506)
- chore(deps): update rust crate clap to v4.6.0 [`#2538`](https://github.com/ast-grep/ast-grep/pull/2538)
- fix(deps): update rust crate tree-sitter-scala to 0.25.0 [`#2536`](https://github.com/ast-grep/ast-grep/pull/2536)
- chore(deps): update dependency oxlint to v1.55.0 [`#2533`](https://github.com/ast-grep/ast-grep/pull/2533)
- chore(deps): update rust crate clap_complete to v4.6.0 [`#2539`](https://github.com/ast-grep/ast-grep/pull/2539)
- chore(deps): update rust crate bit-set to v0.9.1 [`#2537`](https://github.com/ast-grep/ast-grep/pull/2537)
- chore(deps): update rust crate bit-set to 0.9.0 [`#2527`](https://github.com/ast-grep/ast-grep/pull/2527)
- chore(deps): update rust crate assert_cmd to v2.2.0 [`#2529`](https://github.com/ast-grep/ast-grep/pull/2529)
- chore(deps): update rust crate tempfile to v3.27.0 [`#2531`](https://github.com/ast-grep/ast-grep/pull/2531)
- fix(lsp): scan injected languages for diagnostics [`#2528`](https://github.com/ast-grep/ast-grep/pull/2528)
- chore(deps): update dependency @ast-grep/napi to v0.41.1 [`#2526`](https://github.com/ast-grep/ast-grep/pull/2526)
- chore(deps): update dependency oxlint to v1.52.0 [`#2524`](https://github.com/ast-grep/ast-grep/pull/2524)
- feat: support nth-child esquery [`#2546`](https://github.com/ast-grep/ast-grep/issues/2546)
- feat: support :is selector [`#2545`](https://github.com/ast-grep/ast-grep/issues/2545)
- feat: support :not selector [`#2544`](https://github.com/ast-grep/ast-grep/issues/2544)
- feat: support :has rule [`#2543`](https://github.com/ast-grep/ast-grep/issues/2543)
- fix(lsp): scan injected languages for diagnostics (#2528) [`#2522`](https://github.com/ast-grep/ast-grep/issues/2522)
- feat: add parameterized util [`3d90372`](https://github.com/ast-grep/ast-grep/commit/3d903727c2fad6f7ed24cc4852f66b3adc45c7a2)
- refactor: limit parameterized utils to globals [`2d69a34`](https://github.com/ast-grep/ast-grep/commit/2d69a3425b9917653a01f4d56aff9332b0c86538)
- refactor: move parameterized_util [`c77e38d`](https://github.com/ast-grep/ast-grep/commit/c77e38d84281e3bbbe3e5828dd9989d8e721a8a1)

#### [0.41.1](https://github.com/ast-grep/ast-grep/compare/0.41.0...0.41.1)

> 10 March 2026

- fix: lsp on change encounter deadlock [`#2511`](https://github.com/ast-grep/ast-grep/pull/2511)
- chore(deps): update dependency oxlint to v1.51.0 [`#2512`](https://github.com/ast-grep/ast-grep/pull/2512)
- chore(deps): update rust crate tempfile to v3.26.0 [`#2497`](https://github.com/ast-grep/ast-grep/pull/2497)
- chore(deps): update rust crate inquire to v0.9.4 [`#2498`](https://github.com/ast-grep/ast-grep/pull/2498)
- chore(deps): update dependency @types/node to v24.11.0 [`#2502`](https://github.com/ast-grep/ast-grep/pull/2502)
- chore(deps): update dependency dprint to v0.52.0 [`#2499`](https://github.com/ast-grep/ast-grep/pull/2499)
- fix: override severity on `rule` & `inline-rules` flags [`#2505`](https://github.com/ast-grep/ast-grep/pull/2505)
- chore(deps): update github artifact actions [`#2507`](https://github.com/ast-grep/ast-grep/pull/2507)
- chore(deps): update rust crate tree-sitter to v0.26.6 [`#2501`](https://github.com/ast-grep/ast-grep/pull/2501)
- chore(deps): update dependency web-tree-sitter to v0.26.6 [`#2500`](https://github.com/ast-grep/ast-grep/pull/2500)
- chore(deps): update dependency ava to v7 [`#2508`](https://github.com/ast-grep/ast-grep/pull/2508)
- chore(deps): update dependency oxlint to v1.50.0 [`#2495`](https://github.com/ast-grep/ast-grep/pull/2495)
- chore(deps): update dependency @ast-grep/napi to v0.41.0 [`#2494`](https://github.com/ast-grep/ast-grep/pull/2494)
- fix: bump ls-types version [`#2525`](https://github.com/ast-grep/ast-grep/issues/2525)
- refactor: change versioned ast work [`a86b2ab`](https://github.com/ast-grep/ast-grep/commit/a86b2abe5dc4997c892274017f40c7a75c7df354)
- fix: bump wasm-bindgen [`d23e334`](https://github.com/ast-grep/ast-grep/commit/d23e3344df921bbfe9ef1fa84ee9aeceeb543038)
- fix: fix wasm package [`0b92e94`](https://github.com/ast-grep/ast-grep/commit/0b92e941ef54d3c1810283b5471282ad2793f8d5)

#### [0.41.0](https://github.com/ast-grep/ast-grep/compare/0.40.5...0.41.0)

> 22 February 2026

- chore(deps): update pyo3/maturin-action action to v1.50.0 [`#2465`](https://github.com/ast-grep/ast-grep/pull/2465)
- fix(deps): update rust-wasm-bindgen monorepo [`#2491`](https://github.com/ast-grep/ast-grep/pull/2491)
- chore(deps): update rust crate toml_edit to v0.25.3 [`#2469`](https://github.com/ast-grep/ast-grep/pull/2469)
- chore(deps): update dependency web-tree-sitter to ^0.26.0 [`#2492`](https://github.com/ast-grep/ast-grep/pull/2492)
- refactor: addr_of_mut to OnceLock [`#2486`](https://github.com/ast-grep/ast-grep/pull/2486)
- feat: support ast-grep-wasm [`#2484`](https://github.com/ast-grep/ast-grep/pull/2484)
- chore(deps): update rust crate clap to v4.5.60 [`#2483`](https://github.com/ast-grep/ast-grep/pull/2483)
- chore(deps): update rust crate anyhow to v1.0.102 [`#2489`](https://github.com/ast-grep/ast-grep/pull/2489)
- chore(deps): update dependency oxlint to v1.49.0 [`#2488`](https://github.com/ast-grep/ast-grep/pull/2488)
- feat: make default rule id to filename [`#2482`](https://github.com/ast-grep/ast-grep/pull/2482)
- chore(deps): update dependency oxlint to v1.48.0 [`#2481`](https://github.com/ast-grep/ast-grep/pull/2481)
- chore(deps): update rust crate napi-derive to v3.5.2 [`#2475`](https://github.com/ast-grep/ast-grep/pull/2475)
- chore(deps): update rust crate napi to v3.8.3 [`#2474`](https://github.com/ast-grep/ast-grep/pull/2474)
- chore(deps): update rust crate futures to v0.3.32 [`#2476`](https://github.com/ast-grep/ast-grep/pull/2476)
- chore(deps): update rust crate clap to v4.5.58 [`#2470`](https://github.com/ast-grep/ast-grep/pull/2470)
- fix: parse each language injection region as independent tree [`#2479`](https://github.com/ast-grep/ast-grep/pull/2479)
- chore(deps): update dependency @types/node to v24.10.13 [`#2467`](https://github.com/ast-grep/ast-grep/pull/2467)
- chore(deps): update rust crate clap_complete to v4.5.66 [`#2471`](https://github.com/ast-grep/ast-grep/pull/2471)
- chore(deps): update rust crate predicates to v3.1.4 [`#2472`](https://github.com/ast-grep/ast-grep/pull/2472)
- chore(deps): update dependency oxlint to v1.47.0 [`#2468`](https://github.com/ast-grep/ast-grep/pull/2468)
- chore(deps): update rust crate tempfile to v3.25.0 [`#2466`](https://github.com/ast-grep/ast-grep/pull/2466)
- fix(deps): update rust crate toml_edit to 0.25.0 [`#2473`](https://github.com/ast-grep/ast-grep/pull/2473)
- chore(deps): update rust crate tree-sitter to v0.26.5 [`#2458`](https://github.com/ast-grep/ast-grep/pull/2458)
- chore(deps): update dependency @types/node to v24.10.12 [`#2438`](https://github.com/ast-grep/ast-grep/pull/2438)
- chore(deps): update rust crate schemars to v1.2.1 [`#2457`](https://github.com/ast-grep/ast-grep/pull/2457)
- chore(deps): update rust crate clap to v4.5.57 [`#2455`](https://github.com/ast-grep/ast-grep/pull/2455)
- chore(deps): update rust crate anyhow to v1.0.101 [`#2462`](https://github.com/ast-grep/ast-grep/pull/2462)
- chore(deps): update rust crate inquire to v0.9.3 [`#2463`](https://github.com/ast-grep/ast-grep/pull/2463)
- chore(deps): update dependency oxlint to v1.43.0 [`#2459`](https://github.com/ast-grep/ast-grep/pull/2459)
- chore(deps): update rust crate regex to v1.12.3 [`#2461`](https://github.com/ast-grep/ast-grep/pull/2461)
- chore(deps): update rust crate clap to v4.5.55 [`#2454`](https://github.com/ast-grep/ast-grep/pull/2454)
- chore(deps): update dependency oxlint to v1.42.0 [`#2452`](https://github.com/ast-grep/ast-grep/pull/2452)
- chore(deps): update dependency oxlint to v1.41.0 [`#2447`](https://github.com/ast-grep/ast-grep/pull/2447)
- chore(deps): update rust crate assert_cmd to v2.1.2 [`#2437`](https://github.com/ast-grep/ast-grep/pull/2437)
- chore(deps): update rust crate thiserror to v2.0.18 [`#2446`](https://github.com/ast-grep/ast-grep/pull/2446)
- chore(deps): update dependency oxlint to v1.39.0 [`#2442`](https://github.com/ast-grep/ast-grep/pull/2442)
- chore(deps): update rust crate inquire to v0.9.2 [`#2445`](https://github.com/ast-grep/ast-grep/pull/2445)
- fix: improve max diagnostic impl to use one atomic op [`781ec81`](https://github.com/ast-grep/ast-grep/commit/781ec81cb4eba2678c3785a1e322f953dbb5a8d8)
- fix: udpate schema [`e645fdf`](https://github.com/ast-grep/ast-grep/commit/e645fdfa1af85fc5c69ed167bce2eb123dbeb1cc)
- fix: move dumping to core crate [`0b2acb9`](https://github.com/ast-grep/ast-grep/commit/0b2acb96bc8862d8baa657c724402a5b181033e2)

#### [0.40.5](https://github.com/ast-grep/ast-grep/compare/0.40.4...0.40.5)

> 10 January 2026

- fix: fix error code returning 1 for non-result related error [`#2403`](https://github.com/ast-grep/ast-grep/issues/2403)
- feat: support case insensitive option in files/ignores [`#2432`](https://github.com/ast-grep/ast-grep/issues/2432)
- chore(deps): update dependency @ast-grep/napi to v0.40.4 [`4fca101`](https://github.com/ast-grep/ast-grep/commit/4fca10150bdf81a18a09f9b964e989e485845c46)
- chore(deps): update dependency oxlint to v1.38.0 [`622da37`](https://github.com/ast-grep/ast-grep/commit/622da3765f2bbc87414da07213dbb92404667014)
- chore(deps): update dependency oxlint to v1.37.0 [`1a021ba`](https://github.com/ast-grep/ast-grep/commit/1a021ba41faad4f5b14fe5b64b8578d7442af3cc)

#### [0.40.4](https://github.com/ast-grep/ast-grep/compare/0.40.3...0.40.4)

> 4 January 2026

- feat: support --files-with-matches to list all files like ripgrep [`#2371`](https://github.com/ast-grep/ast-grep/issues/2371)
- fix: use new assert_cmd command [`#2399`](https://github.com/ast-grep/ast-grep/issues/2399)
- chore(deps): update dependency dprint to v0.51.1 [`9d00e5b`](https://github.com/ast-grep/ast-grep/commit/9d00e5bef18ee8dd27b5c6c46b5b1cbe6a604652)
- chore(deps): update dependency @ast-grep/napi to v0.40.3 [`80f9c2b`](https://github.com/ast-grep/ast-grep/commit/80f9c2be2931494f91e4bbc72fd988d8c8d4d15c)
- chore(deps): update dependency oxlint to v1.36.0 [`dea9153`](https://github.com/ast-grep/ast-grep/commit/dea91530d5866b31e4965e03d4856e25cd18755f)

#### [0.40.3](https://github.com/ast-grep/ast-grep/compare/0.40.2...0.40.3)

> 15 December 2025

- chore(deps): update dependency @types/node to v24.10.4 [`6a429db`](https://github.com/ast-grep/ast-grep/commit/6a429db049d80da2b90e40d25933f4d43d703dcd)
- fix: remove debug println! from KindMatcher [`fa5cc7b`](https://github.com/ast-grep/ast-grep/commit/fa5cc7b5f170c5323badeb9d1557ead09a470337)

#### [0.40.2](https://github.com/ast-grep/ast-grep/compare/0.40.1...0.40.2)

> 14 December 2025

- fix: exit status to 1 when no match [`#2392`](https://github.com/ast-grep/ast-grep/pull/2392)
- fix: reject unknown keys for pattern [`#2390`](https://github.com/ast-grep/ast-grep/issues/2390)
- fix: allow number in identifier [`#2387`](https://github.com/ast-grep/ast-grep/issues/2387)
- chore(deps): update dependency @napi-rs/cli to v3.5.0 [`090fcd0`](https://github.com/ast-grep/ast-grep/commit/090fcd0046f568c082bfb61cc7ab34ca87ed44bd)
- chore(deps): update dependency @ast-grep/napi to v0.40.1 [`ac69fd7`](https://github.com/ast-grep/ast-grep/commit/ac69fd7cceddb5aae15b93294a616f93dd59ba80)
- chore: bump lsp version [`58138ad`](https://github.com/ast-grep/ast-grep/commit/58138ad289f40ffcdac4017212557c670389514a)

#### [0.40.1](https://github.com/ast-grep/ast-grep/compare/0.40.0...0.40.1)

> 11 December 2025

- chore: add a link to the badges [`#2370`](https://github.com/ast-grep/ast-grep/pull/2370)
- fix: fix AST strictness check [`#2361`](https://github.com/ast-grep/ast-grep/issues/2361)
- chore(deps): update dependency @ast-grep/napi to v0.40.0 [`c98f0dc`](https://github.com/ast-grep/ast-grep/commit/c98f0dcee95e64c2b2076e79236ab083eb29a2f3)
- fix: use individual flag for parser [`2bdcecb`](https://github.com/ast-grep/ast-grep/commit/2bdcecb1bf3b701b0e5bec8c073e60f7d35bc81e)
- chore(deps): update dependency oxlint to v1.32.0 [`b058028`](https://github.com/ast-grep/ast-grep/commit/b058028925d92775f0c2c66208d22b4864ef2dac)
