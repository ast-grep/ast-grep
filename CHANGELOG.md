...
- first standalone `ast-grep-dart` fork release
- add first-class Dart language support via tree-sitter-dart
- rebrand packages, repository metadata, and documentation for independent maintenance
- add npm-first release guidance and optional-registry secrets documentation
- make crates.io and PyPI publishing opt-in for this fork
