...
- fix: do not publish napi [`553f5e5`](https://github.com/ast-grep/ast-grep/commit/553f5e5ac577b6d2e0904c423bb5dbd27804328b)
...
- feat: only scan rule sensitive files [`#1635`](https://github.com/ast-grep/ast-grep/issues/1635)
...
- fix: fix bug report bug again [`61921f7`](https://github.com/ast-grep/ast-grep/commit/61921f7765f38730c66cd7d4e0a3aa816ad14ebf)
...
- refactor: make rewrite test simpler [`5a754ef`](https://github.com/ast-grep/ast-grep/commit/5a754eff27c6ba549a35f5728ec315a4727bfe71)
...
- feat: support rewriter check in sub-rule [`eb4c47c`](https://github.com/ast-grep/ast-grep/commit/eb4c47ca31a22314455b9b55ec10473a6a56dc69)
...
- feat: support multiple rules in -r and --inline-rules [`#786`](https://github.com/ast-grep/ast-grep/issues/786)
...
- infra: add napi benchmark [`#442`](https://github.com/ast-grep/ast-grep/issues/442)
...
- fix: use get_range instead as_slice to handle byte_offset and underlying array size [`#400`](https://github.com/ast-grep/ast-grep/issues/400)
...
- [fix] Add Rust example test, fix #6 [`#6`](https://github.com/ast-grep/ast-grep/issues/6)
